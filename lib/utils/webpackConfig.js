    ...
    if (commandIdentifier) {
      plugins.push(
        new webpack.ProvidePlugin({
          'console': path.join(__dirname, '..', '..', 'node_modules', 'sketch-module-console-polyfill'),
          'fetch': path.join(__dirname, '..', '..','node_modules', 'sketch-module-fetch-polyfill'),
          'setTimeout': [path.join(__dirname, '..', '..','node_modules', 'sketch-module-settimeout-polyfill'), 'setTimeout'],
          'clearTimeout': [path.join(__dirname, '..', '..','node_modules', 'sketch-module-settimeout-polyfill'), 'clearTimeout'],
          'setInterval': [path.join(__dirname, '..', '..','node_modules', 'sketch-module-setinterval-polyfill'), 'setInterval'],
          'clearInterval': [path.join(__dirname, '..', '..','node_modules', 'sketch-module-setinterval-polyfill'), 'clearInterval']
        })
      )
    }
